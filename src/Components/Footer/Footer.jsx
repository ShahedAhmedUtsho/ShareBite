        ...
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                ...
                <ul className="flex items-center space-x-3 mt-9">
                    <li>
                        <Link to="" className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
            ...
            <div>
                <p className="text-sm font-semibold tracking-widest text-gray-400 uppercase"> authorization</p>

                <ul className="mt-6 space-y-4">
                <li>
                    <Link to="/login" className="flex text-base text-slate-500 transition-all duration-200 hover:text-blue-600 focus:text-blue-600">
                        Login
                    ...
                    <li>
                    <Link to="register" className="flex text-base text-slate-500 transition-all duration-200 hover:text-blue-600 focus:text-blue-600">
                        Register
            ...
            <div>
                ...
                <ul className="mt-6 space-y-4">
                <li>
                    <Link to="/" className="flex text-base text-slate-500 transition-all duration-200 hover:text-blue-600 focus:text-blue-600">
Home
</Link>
                    </li>
                <li>
            ...
            <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                ...
                <form action="#" method="POST" className="mt-6">
                    <div>
                        ...
                        <input type="email" name="footerEmail" id="footerEmail" placeholder="Enter your email" className="block w-full p-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-blue-600 caret-blue-600" />
                    </div>
        ...
        <p className="text-sm text-center text-gray-600">© Copyright 2024, All Rights Reserved by ShahedAhmedUtsho</p>
    </div>
</section>
